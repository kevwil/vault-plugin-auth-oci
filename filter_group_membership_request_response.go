...
// FilterGroupMembershipRequest stores the request body and meta-data required for filtering the group membership
...
// FilterGroupMembershipResponse stores the response of the FilterGroupMembership request, including meta-data.
