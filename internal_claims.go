...
// InternalClaim is a representation of a JWT claim
...
var (
	// ClaimPrincipalType var defines the Principal type key
	ClaimPrincipalType = "ptype"
)

// InternalClaims represents a collection of JWT claims
...
// FromClaim takes in a claim and coverts it to an InternalClaim
